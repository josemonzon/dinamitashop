...
<body>
    ...
    <div id="contenido" class="container margenContainer" style="background-color:white; padding:50px; position: relative; z-index:2;">
        <!-- Categorias -->
        <div class="card-deck">
            <div class="card">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <div class="card">
                    <img class="card-img" src="https://static.netshoes.com.ar/produtos/zapatillas-nike-nightgaze/59/001-1397-059/001-1397-059_zoom1.jpg" alt="Vans">
                    <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="col-12">
                        <a class="navbar-brand text-secondary" style="font-family: 'Alata', sans-serif;" href="registro.html">
                            Registro</a>
                    </div>
                    <div class="col-12">
