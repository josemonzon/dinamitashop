    ...
    <nav class="fixed-top navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav mr-auto">
                ...
                <a class="nav-item nav-link active" href="perfil.php">Perfil</a>
            </div>
    ...
    <div class="border rounded container margenContacto">
        <div class="row my-3">
            ...
            <div class="col-lg-4 order-lg-1 text-center">
                <img src="https://media.licdn.com/dms/image/C4E03AQGTsY_h6x_OUg/profile-displayphoto-shrink_800_800/0?e=1579737600&v=beta&t=lp1VXIvrMIUWNv5C3bLsVvHJ-zm1jeiNlqSQj4ZE_Ok"
